...
from cloudconnectlib.common.util import is_valid_port, load_json_file
...
def test_load_proxy():
    ...
    bad_proxy = [
        {"enabled": "BAD BOOL", "host": "host", "port": "BAD port"},
        {"enabled": "BAD BOOL", "host": "host", "port": "1024"},
        {"enabled": "TRUE", "host": "host", "port": "BAD port"},
    ]
    for bp in bad_proxy:
    ...
    good_proxy = [
        {"enabled": "True", "host": "host", "port": "1"},
        {"enabled": "True", "host": "host", "port": "65535"},
        {"enabled": "TRUE", "host": "host", "port": "1024"},
        {"enabled": True, "host": "host", "port": "1024"},
        {"enabled": 1, "host": "host", "port": "1024"},
        {"enabled": "1", "host": "host", "port": "1024"},
    ]
...
def test_load_global_setting():
    setting_log_only = {"logging": {"level": "abc"}}
    loader, _ = get_loader_by_version("1.0.0")
